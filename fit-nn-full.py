...
for j_stim in stim_nodes:
    ...
    predict_k_y = logtransform_y.inverse_transform(predict_k_x)
    ...
    predict_k_y_scaled_new = trained_nn_model_new.predict(
            logtransform_x.transform(predict_k_x))
    predict_k_y_new = logtransform_x.inverse_transform(predict_k_y_scaled_new)
