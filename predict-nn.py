...
To run this:
    1. Specify the electrodes not to be included in prediction in line 79. 
    
    2. Specify the electrode array position information in lines 82-85. By default, 
...
for i, input_id in enumerate(input_ids):
    ...
    for j_stim, j_stim_pos in zip(stim_nodes, stim_relative_position): 
        ...
        predict_x = [np.append([i, j_stim_pos], logtransform_x.transform(
                    input_value)) for i in electrode_pos_pred]
